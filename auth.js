...
async function runDemo() {
  ...
  // 2) Fetch and display all stored logs
  await fetchThreatLogs();

  console.log("\n Note: In SurakshaNet, these logs are instead verified, hashed, and stored immutably on our blockchain layer.");
}
